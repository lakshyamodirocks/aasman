...
if stage_opt "Pentest toolkit" "nmap · hydra · nikto · sqlmap · ffuf/nuclei (recon tools)" "SIRF apne device / apne lab / CTF pe. Golang download bhaari (~1-2 min). Zaroorat na ho to skip."; then
